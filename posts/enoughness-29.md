...
在這之前，科學界普遍認為視覺系統類似電視機螢幕，以「逐點（pixel-by-pixel）」、「連續」的方式處理訊號。這個貓實驗讓我們知道，V1 內部既沒有螢幕，也沒有像素的概念，而是先拆解成基本特徵後，再由更高階的 V2、V4 進一步整合、辨識，最終才是我們肉眼所見的完整畫面。
